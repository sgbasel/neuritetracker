...
%%
Magnification = '10x';
dataRootDirectory    = ['/home/ksmith/Dropbox/Sinergia_LOCAL/EvaluationOfNucleiAndSomata/GT' Magnification '/Dynamic/'];
ConvertedGTRootDir   = ['/home/ksmith/Dropbox/Sinergia_LOCAL/EvaluationOfNucleiAndSomata/GT' Magnification '/Dynamic_matlab/'];
RawRootDataDirectory = ['/home/ksmith/Dropbox/Sinergia_LOCAL/EvaluationOfNucleiAndSomata/Selection' Magnification '/'];
DetectionDirectory   = ['/home/ksmith/Dropbox/Sinergia_LOCAL/EvaluationOfNucleiAndSomata/Detections' Magnification '/'];
...
%        disp(['Original Sequence: ' inputSeqDirToProcess]);       
       ...
       GTFileName = [ConvertedGTRootDir listOfGTSeq(i).name '.mat'];
