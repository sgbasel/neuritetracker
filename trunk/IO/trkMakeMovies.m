...
if output.movieTubularity
    try
        ...
        FolderMovie = sprintf('%s/movie_tubularity/', output.destFolder);
...
if output.movieNeuriteProbability
    try
        ...
        FolderMovie = sprintf('%s/movie_neurite_prob/', output.destFolder);
...
if output.movieCellSegmentation
    try
        ...
        FolderMovie = sprintf('%s/movie_cell_body_segment/', output.destFolder);
...
if output.movieBacktracing
    try
        ...
        FolderMovie = sprintf('%s/movie_neurite_backtracing/', output.destFolder);
...
if output.movieFinal
    try
        ...
        FolderMovie = sprintf('%s/movie_final/', output.destFolder);
...
if output.movieFinalNumbered
    try
        ...
        FolderMovie = sprintf('%s/movie_final_numbered/', output.destFolder);
...
if output.movieExtractedModel
    try
        ...
        FolderMovie = sprintf('%s/movie_extracted_HDS_model/', output.destFolder);
